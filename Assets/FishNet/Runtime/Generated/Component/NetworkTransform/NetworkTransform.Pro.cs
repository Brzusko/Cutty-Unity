...
//         {
//             //PROSTART
//             Vector3 position = (nextProperties.Position - previousProperties.Position) + nextProperties.Position;
//             Quaternion rotation = (nextProperties.Rotation * Quaternion.Inverse(previousProperties.Rotation)) * nextProperties.Rotation;
//             Vector3 scale = (nextProperties.Scale - previousProperties.Scale) + nextProperties.Scale;
//
